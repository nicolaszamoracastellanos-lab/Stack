      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={cn(
              "min-h-11 flex-1 rounded-pill px-3 py-2 text-label font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-volt/60",
              active
                ? "bg-volt text-bg"
