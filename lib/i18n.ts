...
export const translations = {
  en: {
    ...
    pact_intention_ph: "Get shredded for Nico's wedding",
    pact_motivation_label: "Motivation",
    pact_motivation_ph: "What's really driving this",
    pact_endgoal_label: "End goal",
    pact_endgoal_ph: "Lose 10 kg by November",
    pact_meaning_label: "What it means",
    ...
    pact_duration_label: "Challenge duration",
    pact_duration_fixed: "Fixed",
    pact_duration_ongoing: "Ongoing",
    pact_weeks: "{n} weeks",
    pact_custom_weeks: "Weeks",
    pact_stake_label: "The stake",
    pact_stake_none: "No stake",
    pact_stake_money: "Money",
    pact_stake_favor: "A favor",
    pact_stake_custom: "Custom",
    ...
    pact_whopays_any_misser: "Anyone who misses",
    pact_whopays_any_misser_desc: "Everyone who misses the weekly target pays.",
    pact_whopays_last_place: "Last place",
    pact_whopays_last_place_desc: "The lowest member each cycle pays.",
    pact_save: "Save pact",
    pact_err_workouts: "Set workouts per week.",
    pact_err_duration: "Choose a duration.",
    pact_err_stake_value: "Describe the stake.",
    pact_err_whopays: "Choose who pays.",
    // Pact display on the group page
    pact_about_label: "About this pact",
    pact_summary_label: "The pact",
    pact_setup_cta: "Set up the pact",
    pact_edit_cta: "Edit pact",
    pact_per_week: "{n}/week",
    pact_breaker_pays: "Only the breaker pays",
    pact_any_misser_pays: "Anyone who misses pays",
    ...
    proposal_label: "Rule change proposed",
    proposal_by: "{name} proposed a new pact:",
    proposal_status: "{approved} of {total} approved",
    ...
    checkin_mirror_label: "Mirror photo",
    checkin_mirror_hint: "For selfies that read backwards. Off keeps the true orientation.",
    ...
    cd_next: "Next",
    // Story card
    card_template_label: "Template",
    card_show_label: "Show",
    card_tpl_minimal: "Minimal",
    card_tpl_bold: "Bold",
    card_tpl_stat: "Stat-heavy",
    card_tpl_photo: "Photo",
    card_tpl_milestone: "Milestone",
    card_toggle_sport: "Sport",
    card_toggle_focus: "Focus",
    card_toggle_notes: "Notes",
    card_toggle_streak: "Streak",
    card_toggle_date: "Date",
    card_milestone_caption: "{n} days. No misses.",
  ...
  es: {
    ...
    pact_intention_ph: "Ponernos en forma para la boda de Nico",
    pact_motivation_label: "Motivación",
    pact_motivation_ph: "Lo que de verdad nos mueve",
    pact_endgoal_label: "Meta final",
    pact_endgoal_ph: "Bajar 10 kg para noviembre",
    pact_meaning_label: "Lo que significa",
    ...
    pact_duration_label: "Duración del reto",
    pact_duration_fixed: "Fija",
    pact_duration_ongoing: "Indefinida",
    pact_weeks: "{n} semanas",
    pact_custom_weeks: "Semanas",
    pact_stake_label: "La apuesta",
    pact_stake_none: "Sin apuesta",
    pact_stake_money: "Dinero",
    pact_stake_favor: "Un favor",
    pact_stake_custom: "Personalizada",
    pact_stake_money_ph: "$20",
    ...
    pact_whopays_any_misser: "Cualquiera que falle",
    pact_whopays_any_misser_desc: "Todos los que no lleguen a la meta semanal pagan.",
    pact_whopays_last_place: "Último lugar",
    pact_whopays_last_place_desc: "El de menor cumplimiento de cada ciclo paga.",
    pact_save: "Guardar pacto",
    pact_err_workouts: "Define los entrenamientos por semana.",
    pact_err_duration: "Elige una duración.",
    pact_err_stake_value: "Describe la apuesta.",
    pact_err_whopays: "Elige quién paga.",
    // Pact display on the group page
    pact_about_label: "Sobre este pacto",
    pact_summary_label: "El pacto",
    pact_setup_cta: "Armar el pacto",
    pact_edit_cta: "Editar pacto",
    pact_per_week: "{n}/semana",
    pact_breaker_pays: "Solo paga quien rompe",
    pact_any_misser_pays: "Paga cualquiera que falle",
    ...
    card_tpl_photo: "Foto",
    card_tpl_milestone: "Hito",
    card_toggle_sport: "Deporte",
    card_toggle_focus: "Enfoque",
    card_toggle_notes: "Notas",
    card_toggle_streak: "Racha",
    card_toggle_date: "Fecha",
    card_milestone_caption: "{n} días. Sin fallar.",
