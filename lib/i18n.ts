...
export const translations = {
  en: {
    ...
    pact_alert_behind_many: "{names} haven't stacked a workout this week.",
    pact_alert_target: "Target: {n}×/week · stake {stake}",
    ...
    forgot_subtitle: "Enter your email and we'll send you a link to set a new password.",
    forgot_submit: "Send reset link",
    forgot_sent: "If that email has an account, a reset link is on its way. Check your inbox.",
    ...
    reset_mismatch: "The passwords don't match.",
    reset_success: "Password updated. Taking you in.",
    reset_no_session: "This reset link is invalid or has expired. Request a new one.",
    ...
    username_placeholder: "alexrivera",
    display_name_label: "Display name (optional)",
    display_name_placeholder: "Alex Rivera",
    ...
    // Celebration (v3 §3.3) — the slam word is brand vocabulary, not a
    // translation. Founder reviews final ES copy.
    celebrate_title: "STACKED",
    celebrate_posted_to: "Posted to {groups}",
    celebrate_solo: "Logged. Just you and the work.",
    celebrate_this_week: "This week",
    celebrate_consistency: "Consistency",
    celebrate_total: "Total days",
    celebrate_share: "Share story card",
    celebrate_done: "Done",
    ...
    notif_master_hint: "Nudges, group activity, and streak alerts.",
    notif_enable: "Enable",
    ...
    notif_quiet_hint: "No notifications during these hours (your local time).",
    notif_quiet_from: "From",
    notif_quiet_to: "To",
    notif_type_group_post: "Posts in your groups",
    notif_type_group_join: "Someone joins a group",
    notif_type_member_workout: "A member's first workout",
    notif_type_self_nudge: "Evening streak reminder",
    notif_type_at_risk: "About to lose your streak",
    notif_type_member_nudge: "Someone nudges you",
    notif_type_tier_projection: "Tier changes & projections",
    // Notification center (Batch 6)
    notifc_title: "Activity",
    notifc_today: "Today",
    notifc_earlier: "Earlier",
    notifc_empty_title: "Nothing yet",
    notifc_empty_body:
      "When your crew reacts, comments, nudges, or joins, it shows up here.",
    notifc_back: "Back",
    home_tab_activity: "All Activity",
    home_tab_groups: "Groups",
    home_pinned: "Pinned",
    home_today: "Today",
    home_earlier: "Earlier",
    home_feed_empty_title: "No activity yet",
    home_feed_empty_body: "When your groups post check-ins, they show up here.",
    home_solo_empty_body:
      "Start a group or join one with a link to see a shared activity feed here.",
    feed_posted_in: "in {groups}",
    group_card_today: "{n} checked in today",
    group_card_streak: "{n} day group streak",
    home_pin: "Pin",
    home_unpin: "Unpin",
    home_pin_full: "You can pin up to 3 groups",
    home_move_up: "Move up",
    notif_desc_reaction: "{name} reacted to your check-in",
    notif_desc_comment: "{name} commented: {snippet}",
    notif_desc_comment_plain: "{name} commented on your check-in",
    notif_desc_mention: "{name} mentioned you: {snippet}",
    notif_desc_mention_plain: "{name} mentioned you",
    notif_desc_nudge: "{name} nudged you to work out",
    notif_desc_group_join: "{name} joined {group}",
    notif_desc_invite_accepted: "{name} accepted your invite to {group}",
    notif_desc_group_post: "{name} posted in {group}",
    notif_desc_member_workout: "{name} logged a workout in {group}",
    notif_desc_tier_change: "You earned {tier}",
  ...
  es: {
    ...
    forgot_subtitle: "Escribe tu correo y te enviaremos un enlace para crear una nueva contraseña.",
    forgot_submit: "Enviar enlace",
    forgot_sent: "Si ese correo tiene una cuenta, el enlace va en camino. Revisa tu bandeja.",
    forgot_back_login: "Volver a iniciar sesión",
    ...
    reset_success: "Contraseña actualizada. Entrando.",
    reset_no_session: "Este enlace no es válido o expiró. Solicita uno nuevo.",
    ...
    celebrate_title: "STACKEADO",
    celebrate_posted_to: "Publicado en {groups}",
    celebrate_solo: "Registrado. Solo tú y el trabajo.",
    celebrate_this_week: "Esta semana",
    celebrate_consistency: "Constancia",
    celebrate_total: "Días totales",
    celebrate_share: "Compartir story card",
    celebrate_done: "Listo",
    ...
    notif_master_hint: "Empujones, actividad del grupo y alertas de racha.",
    notif_enable: "Activar",
    ...
    notif_quiet_hint: "Sin notificaciones durante estas horas (tu hora local).",
    notif_quiet_from: "Desde",
    notif_quiet_to: "Hasta",
    notif_type_group_post: "Publicaciones en tus grupos",
    notif_type_group_join: "Alguien se une a un grupo",
    notif_type_member_workout: "El primer entrenamiento de un miembro",
    notif_type_self_nudge: "Recordatorio de racha por la tarde",
    notif_type_at_risk: "A punto de perder tu racha",
    notif_type_member_nudge: "Alguien te da un empujón",
    notif_type_tier_projection: "Cambios y proyecciones de nivel",
    // Notification center (Batch 6)
    notifc_title: "Actividad",
    notifc_today: "Hoy",
    notifc_earlier: "Antes",
    notifc_empty_title: "Nada todavía",
    notifc_empty_body:
      "Cuando tu gente reacciona, comenta, te da un empujón o se une, aparece aquí.",
    notifc_back: "Atrás",
    home_tab_activity: "Toda la actividad",
    home_tab_groups: "Grupos",
    home_pinned: "Fijados",
    home_today: "Hoy",
    home_earlier: "Antes",
    home_feed_empty_title: "Sin actividad todavía",
    home_feed_empty_body: "Cuando tus grupos publiquen registros, aparecen aquí.",
    home_solo_empty_body:
      "Crea un grupo o únete con un enlace para ver aquí un feed de actividad compartido.",
    feed_posted_in: "en {groups}",
    group_card_today: "{n} se registraron hoy",
    group_card_streak: "racha de grupo de {n} días",
    home_pin: "Fijar",
    home_unpin: "Quitar",
    home_pin_full: "Puedes fijar hasta 3 grupos",
    home_move_up: "Subir",
    notif_desc_reaction: "{name} reaccionó a tu registro",
    notif_desc_comment: "{name} comentó: {snippet}",
    notif_desc_comment_plain: "{name} comentó tu registro",
    notif_desc_mention: "{name} te mencionó: {snippet}",
    notif_desc_mention_plain: "{name} te mencionó",
    notif_desc_nudge: "{name} te dio un empujón para entrenar",
    notif_desc_group_join: "{name} se unió a {group}",
    notif_desc_invite_accepted: "{name} aceptó tu invitación a {group}",
    notif_desc_group_post: "{name} publicó en {group}",
    notif_desc_member_workout: "{name} registró un entrenamiento en {group}",
    notif_desc_tier_change: "Alcanzaste {tier}",
    ...
    push_prompt_later: "Quizás luego",
