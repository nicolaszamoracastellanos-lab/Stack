...
const WAITLIST: Record<Language, WaitlistCopy> = {
  ...
  es: {
    ...
    intro:
      "Bienvenido a Stack: el lugar donde tú y tu círculo cercano se presentan todos los días, stackean entrenamientos juntos y no se dejan rendir.",
    ...
    newspaper:
      "Este es el periódico de Stack. Solo te escribiremos cuando haya algo que valga la pena: nuevas funciones, el lanzamiento en iOS y Android, e historias de los grupos que stackean juntos.",
    signoff: "Ahora ve y stackea uno.",
...
const ONBOARDING: Record<Language, OnboardingCopy> = {
  ...
  es: {
    ...
    features: [
      ...
      "Lleva la cuenta de todo: tu racha, la racha del grupo, la tabla de posiciones, tus estadísticas y tu historial completo.",
